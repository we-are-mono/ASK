...
The first feature increment adds [static IPv4 UDP SNAT](flowtable-nat.md),
including forced address/port translation, reverse traffic, checksum validation
and retirement to software. TCP NAT, MASQUERADE and DNAT remain deferred.
